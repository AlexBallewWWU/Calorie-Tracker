...
data class UserData(
    ...
    // TODO: Add gender object and radiobutton to select it in ProfilePage

    // TODO: Is this how we want to do colorThemeing? enum class means in sql data is stored to matching number (1-3 for dark, light, & custom)
//    val colorTheme: Int
    val gender: Int,
...
data class dateAndWieght(
    ...
    var weight: Double
    // TODO: Update weight based on userdata input in profile ...?
)
