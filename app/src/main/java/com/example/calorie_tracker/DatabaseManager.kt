...
// TODO: You can include basic functions here but I would recommend creating
//  creating your own files like I did for AddFoodChildDM for readability and then inherit this class
// TODO: Also, bc onCreate is only called once if you need to change the
//  database schema after running, you have to either change it via onUpgrade
//  or use this line or delete the database and rewrite onCreate (code in MainActivity)
...
open class DatabaseManager(context: Context) : SQLiteOpenHelper(context, "MyDb",
    ...
    // TODO: To Brennan: targetWeight will be 0 if at log in there was no history of a targetWeight, do with this information as you please
...
//                totalProtein += cursor.getInt(3) // protein stored in third column
    ...
    // TODO: Keep here in nested class or move to seperate file? nested classes could easy access to server since all in one outer class...
    ...
    class userDataDM(context: Context): DatabaseManager(context) {
        ...
        fun insertUserData(myUserData: UserData) {
            // TODO: Make this overwrite the only row in the table instead of inserting new rows... how to do :(
